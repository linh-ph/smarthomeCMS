$(document).ready(function () { 
    $("#datatable").DataTable({
        ...
        drawCallback: function () { $(".dataTables_paginate > .pagination").addClass("pagination-rounded") }, 
            pageLength: 4, searching: !1, lengthChange: !1 
        }); 
        var e = { 
            chart: { 
            ...
            fill: { 
                ...
                yaxis: { 
                    labels: { show: !0 }, 
                    title: { text: "Sales Analytics", offsetX: -10, offsetY: 0 } 
                }, 
                tooltip: { 
                    shared: !0, intersect: !1, 
                    y: { formatter: function (e) { return void 0 !== e ? e.toFixed(0) + " Sales" : e } } 
                }, 
